...
{
    class SubMenuEstoqueBebida
    {
        public static void SubMenuBebi()
        {
            Console.Clear();
        ...
        public static void WriteOptions()
        {
            ...
            Console.Write(" [1]Cadastrar bebida");
            Console.SetCursorPosition(3, 5);
            Console.Write(" [2]Buscar ");
            Console.SetCursorPosition(3, 6);
            Console.Write(" [3]Excluir bebida do estoque");
        ...
        public static void HandleMenuOption(short option)
        {
            ...
            {
                case 1:
                    BebidaControlle.InserirBebidaEstoque();
                    break;
                case 2:
                    BebidaControlle.BuscaBebida();
                    break;
                case 3:
                    BebidaControlle.DeletarBebida();
                    break;
                case 4:
                    CoresPadrao();
