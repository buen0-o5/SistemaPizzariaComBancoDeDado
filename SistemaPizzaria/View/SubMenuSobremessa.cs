...
{
    class SubMenuSobremessa
    {
        public static void SubMenuSobre()
        {
            Console.Clear();
        ...
        public static void WriteOptions()
        {
            ...
            Console.Write(" [1]Cadastrar Sobremessa");
            Console.SetCursorPosition(3, 5);
            Console.Write(" [2]Buscar ");
            Console.SetCursorPosition(3, 6);
            Console.Write(" [3]Excluir sobremessa do cardapio");
        ...
        public static void HandleMenuOption(short option)
        {
            ...
            {
                case 1:
                    SobremessaController.InserirSobremessaEstoque();
                    break;
                case 2:
                    SobremessaController.BuscaSobremessa();
                    break;
                case 3:
                    SobremessaController.DeletarSobremessa();
                    break;
                case 4:
                    CoresPadrao();
